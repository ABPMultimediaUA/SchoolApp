...
class Padre extends REST_Controller {
    ...
    public function padre_post()
    {
        ...
        $this->padre_model->post_padre($this->post());

        $this->output->set_output("Padre added to database", REST_Controller::HTTP_CREATED); // CREATED (201) being the HTTP response code
