...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 07-02-2017 a las 15:59:47
...
(15, 15, 'Sombra', 'McTinieblas', 'conejitofeliz12', '1234', 'sombraconejito@col.bruselas', 123456789, '55555555Q', 1, 1);
...
INSERT INTO `chat` (`Profesor_idProfesor`, `Padre_Alumno_idAlumno`) VALUES
(1, 1),
(1, 2);
...
(2, 'Está mal de la chota', 'No  ceja en su empeño de tirar del pelo a todas las chicas de la clase', 1, 1, 6),
(3, 'Está mal de la chota', 'No  ceja en su empeño de tirar del pelo a todas las chicas de la clase', 1, 1, 6),
(4, 'Está mal de la chota', 'No  ceja en su empeño de tirar del pelo a todas las chicas de la clase', 1, 1, 6);
...
(6, 'Me gustaría aprobar', 1, 6, '2008-10-10 00:00:00');
...
(0, '2008-10-10 00:00:00', '10', 1, 1, 1),
...
(3, 'Marieta', 'Sánchez Gorgorito', '1234', 'maries23', 5, '11111111W', 'asdfg@as.com', 111111111);
...
INSERT INTO `tarea` (`idTarea`, `descripcion`, `fecha_limite`, `completada`, `Asignatura_has_Curso_has_Alumno_idAsignatura`, `Asignatura_has_Curso_has_Alumno_idCurso`, `Asignatura_has_Curso_has_Alumno_idAlumno`) VALUES
(1, 'Describir el ecosistema del gusano de seda', '2016-12-08 23:20:56', 0, 1, 1, 1),
(2, 'Matar a un ruiseñor', '2008-10-10 00:00:00', 0, 1, 1, 1);
...
--
ALTER TABLE `comentarios_sobre_el_alumno`
  MODIFY `idComentarios_sobre_el_alumno` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
--
