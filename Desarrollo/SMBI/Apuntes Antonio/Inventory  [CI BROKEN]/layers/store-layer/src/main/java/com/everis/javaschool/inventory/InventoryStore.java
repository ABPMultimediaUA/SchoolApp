...
public class InventoryStore {
    ...
    private static final Product MOTHERBOARD = new Product("placa base sencilla");
    ...
    static{
        MAPA.put(ProductType.HARDWARE, Arrays.asList(MEMORY_RAM, COMPUTER_GPU, MOTHERBOARD));
